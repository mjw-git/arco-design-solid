...
export interface BaseButtonProps {
   ...
   */
  anchorProps?: JSX.AnchorHTMLAttributes<HTMLAnchorElement>;
  /**
   * @zh 是否禁用
...
export type AnchorButtonProps = {
  ...
  Omit<JSX.AnchorHTMLAttributes<any>, 'type' | 'onClick' | 'className'>;
...
export type FinalButtonProps = {
  ...
  Omit<JSX.ButtonHTMLAttributes<any>, 'type' | 'onClick' | 'className'>;
