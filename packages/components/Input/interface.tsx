...
export interface InputProps
  ...
  autoWidth?:
    | boolean
    | {
        'min-width'?: JSX.CSSProperties['min-width'];
        'max-width'?: JSX.CSSProperties['max-width'];
      };
  /**
  /**
   * @zh 输入时的回调
...
export interface TextAreaProps
  extends Omit<JSX.HTMLAttributes<HTMLTextAreaElement>, 'onChange' | 'class'> {
  style?: JSX.CSSProperties;
  /**
...
export interface InputSearchProps extends InputProps {
   ...
   */
  searchButton?: boolean | JSX.Element;
}
