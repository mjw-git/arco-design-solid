 ...
 * @title Menu
 */
export interface MenuProps extends Omit<JSX.HTMLAttributes<HTMLDivElement>, 'class'> {
   ...
   */
  icons?: {
    horizontalArrowDown?: JSX.Element | null;
    popArrowRight?: JSX.Element | null;
    collapseDefault?: JSX.Element | null;
    collapseActive?: JSX.Element | null;
  };
  /**
   * @zh 默认展开所有多级菜单
   ...
   * @version 2.57.0
   */
  onEllipsisChange?: (status: { lastVisibleIndex: number; overflowNodes: JSX.Element[] }) => void;
 ...
 * @title Menu.SubMenu
 */
export interface MenuSubMenuProps extends Omit<JSX.HTMLAttributes<HTMLElement>, 'title' | 'class'> {
  children?: JSX.Element;
  style?: JSX.CSSProperties;
  class?: string | string[];
  level?: number;
 ...
 * @title Menu.Item
 */
export interface MenuItemProps extends Omit<JSX.HTMLAttributes<HTMLElement>, 'class'> {
  children?: JSX.Element;
  style?: JSX.CSSProperties;
  class?: string | string[];
  level?: number;
