 ...
 * @title Layout.Header
 */
export interface HeaderProps extends Omit<JSX.HTMLAttributes<HTMLElement>, 'class' | 'ref'> {
  class?: string | string[];
}
 ...
 * @title Layout.Footer
 */
export interface FooterProps extends Omit<JSX.HTMLAttributes<HTMLElement>, 'class' | 'ref'> {
  class?: string | string[];
}
